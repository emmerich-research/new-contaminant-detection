...
inline constexpr base<base_container_t, data_t, read_count_t, write_count_t>::
    base(const address_t& starting_address,
         size_type        capacity,
...
inline constexpr sequential<data_t, read_count_t, write_count_t>::sequential(
